...
\section{Plan}
  ...
  \item The implementation of the compiler frontend in OCaml \cite{realworldocaml} (with code generation to a python structure)
    \begin{itemize}
    \item Type checks
    \item Dead code (elseon <ch> after on <ch>)
    \item Synchroniser passport
    \end{itemize}
  \end{enumerate}
