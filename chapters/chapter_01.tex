...
Segmentation marks can be thought of as brackets. \ak\ requires that a sequence can only consist of elements of the same nature, therefore further into the sequence brackets can occur only in the following combination:
\[
