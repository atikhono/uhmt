...
%% Data are typed in \ak\.  Types are CAL terms. Store expression returns data of a valid CAL type (because it just concatenates data).
Store expression is a mechanism to combine data.
